...
<head>
    ...
    <title>Create Student Account — Zeal Virtual Lab</title>
...
<body>
    ...
    <div class="form-container">
        ...
        <p class="form-subtitle">Register a new student account to grant them lab workbench access.</p>
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" id="full_name" name="full_name" placeholder="e.g. Aarav Rao" required <?php echo !$db_connected ? 'disabled' : ''; ?>>
            </div>

            <div class="form-group">
                <label for="username">Username</label>
                <input type="text" id="username" name="username" placeholder="e.g. aarav.rao" required <?php echo !$db_connected ? 'disabled' : ''; ?>>
            </div>
