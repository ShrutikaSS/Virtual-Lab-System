...
(function () {
      ...
      chem: {
        ...
        experiments: [
          ...
          },
          {
            id: 'ch-08',
            tag: 'CH·08',
            title: 'Acid-Base Solutions & Dissociation',
            desc: 'Investigate the behavior of strong and weak acids and bases at the molecular level, checking dissociation and pH.',
            status: 'not-started',
            progress: 0,
            theory: {
              intro: 'Acid-base strength is determined by the extent of ionization in water. Strong acids and bases dissociate completely, whereas weak ones reach a dynamic equilibrium leaving most molecules intact.',
              objectives: [
                'Distinguish between strong and weak acids/bases at a particle level.',
                'Calculate the dissociation constant Ka/Kb from concentration and pH.',
                'Understand percent dissociation and its relationship to initial concentration.'
              ],
              keyFormula: 'K_a = \\frac{[H_3O^+][A^-]}{[HA]}'
            },
            apparatus: [
              { name: 'Magnified Molecular View Inset', qty: '1 unit' },
              { name: 'Equilibrium Concentration Solver', qty: '1 unit' },
              { name: 'pH Probe Attachment', qty: '1 unit' }
            ],
            sim: { type: 'acid_base_solutions' },
            quiz: [
              {
                question: 'Which equation correctly solves the equilibrium concentration x of a weak acid?',
                options: ['x = C', 'x = sqrt(Ka * C)', 'x = (-Ka + sqrt(Ka^2 + 4*Ka*C)) / 2', 'x = Ka * C'],
                correctIndex: 2
              }
            ]
          }
      ...
      phy: {
        ...
        experiments: [
          ...
          },
          {
            id: 'phy-08',
            tag: 'PH·08',
            title: 'Conservation of Energy — Energy Skate Park',
            desc: 'Explore conservation of mechanical energy, potential-to-kinetic energy conversion, and thermal dissipation on a customizable track.',
            status: 'not-started',
            progress: 0,
            theory: {
              intro: 'Conservation of Energy states that energy cannot be created or destroyed, only transformed from one form to another. In this lab, we observe gravitational potential energy converting to kinetic energy and thermal dissipation via friction.',
              objectives: [
                'Understand conversion between Potential and Kinetic energy.',
                'Measure thermal energy generated by friction.',
                'Verify that total energy PE + KE + Thermal remains constant.'
              ],
              keyFormula: 'PE + KE + E_{thermal} = E_{initial}'
            },
            apparatus: [
              { name: 'Draggable Spline Track Board', qty: '1 unit' },
              { name: 'Animated Skater Bob (50kg)', qty: '1 unit' },
              { name: 'Virtual Environment Regulator', qty: '1 unit' },
              { name: 'Digital Energy Bar Chart Logger', qty: '1 unit' }
            ],
            sim: { type: 'skate_park' },
            quiz: [
              {
                question: 'In the absence of friction, what happens to the total mechanical energy of the skater?',
                options: ['It increases as kinetic energy increases', 'It decreases as height increases', 'It remains constant', 'It is entirely converted to thermal energy'],
                correctIndex: 2
              },
              {
                question: 'If the mass of the skater is doubled, what happens to their maximum speed at the bottom of the track (ignoring friction)?',
                options: ['It doubles', 'It quadruples', 'It halves', 'It remains the same'],
                correctIndex: 3
              },
              {
                question: 'What form of energy is mechanical energy converted to due to friction?',
                options: ['Gravitational potential energy', 'Thermal energy (heat)', 'Nuclear energy', 'Chemical energy'],
                correctIndex: 1
              }
            ]
          },
          {
            id: 'phy-09',
            tag: 'PH·09',
            title: 'Newton\'s Second Law — Forces and Motion',
            desc: 'Investigate the relationship between force, mass, and acceleration, and analyze static and kinetic friction thresholds.',
            status: 'not-started',
            progress: 0,
            theory: {
              intro: 'Newton\'s Second Law states that acceleration is net force divided by mass. Friction resists this movement, acting as static friction when stationary and kinetic friction when sliding.',
              objectives: [
                'Observe how force and mass affect acceleration.',
                'Identify static and kinetic friction thresholds.',
                'Verify F = ma using live velocity-time plots.'
              ],
              keyFormula: 'a = \\frac{F_{applied} + F_{friction}}{m}'
            },
            apparatus: [
              { name: 'Draggable Crate Box', qty: '1 unit' },
              { name: 'Selectable Surface Bench (Ice/Wood/Carpet)', qty: '1 unit' },
              { name: 'Calibrated Force Slider', qty: '1 unit' },
              { name: 'Real-time Dual Axis Chart Logger', qty: '1 unit' }
            ],
            sim: { type: 'forces_motion' },
            quiz: [
              {
                question: 'If you double the applied force on a crate while keeping its mass constant (and ignoring friction), the acceleration will:',
                options: ['Double', 'Halve', 'Quadruple', 'Remain unchanged'],
                correctIndex: 0
              },
              {
                question: 'Why does the crate not move immediately when a small force is applied on a wood surface?',
                options: ['Due to kinetic friction', 'Due to gravity', 'Static friction matches and opposes the applied force up to a threshold', 'The normal force is too high'],
                correctIndex: 2
              },
              {
                question: 'Which surface material has the lowest coefficients of static and kinetic friction?',
                options: ['Carpet', 'Wood', 'Ice', 'They are all equal'],
                correctIndex: 2
              }
            ]
          },
          {
            id: 'phy-10',
            tag: 'PH·10',
            title: 'Geometric Optics — Thin Lens Lab',
            desc: 'Explore real and virtual image formation, ray tracing construction, and the thin lens equation for converging and diverging lenses.',
            status: 'not-started',
            progress: 0,
            theory: {
              intro: 'Geometric optics describes light propagation using rays. A thin lens refracts parallel rays to converge or diverge at its focal points, forming real or virtual images depending on object distance.',
              objectives: [
                'Observe thin lens image formation live.',
                'Trace the three principal ray construction paths.',
                'Verify the thin lens equation and magnification relationships.'
              ],
              keyFormula: '\\frac{1}{f} = \\frac{1}{d_o} + \\frac{1}{d_i}'
            },
            apparatus: [
              { name: 'Horizontal Ruled Optical Bench', qty: '1 unit' },
              { name: 'Converging & Diverging Lens Set', qty: '1 set' },
              { name: 'Luminous Arrow Object', qty: '1 unit' },
              { name: 'Draggable Focal Length Indicators', qty: '1 set' }
            ],
            sim: { type: 'lens_lab' },
            quiz: [
              {
                question: 'If a real object is placed at a distance of 2f (twice the focal length) from a convex lens, the image is formed at:',
                options: ['f', '2f', 'Infinity', 'Between f and 2f'],
                correctIndex: 1
              },
              {
                question: 'A diverging (concave) lens always produces what type of image for a real object?',
                options: ['Real and inverted', 'Virtual and upright', 'Real and upright', 'Virtual and inverted'],
                correctIndex: 1
              },
              {
                question: 'What is the magnification of an image if the image distance is twice the object distance and the image is real?',
  ...
  function bindEvents() {
    ...
    document.querySelectorAll('.nav-item').forEach(btn => {
      btn.addEventListener('click', () => {
        ...
        if (view === 'dashboard' || view === 'profile' || view === 'simulations') {
          navigateTo(view);
  ...
  function navigateTo(viewName) {
    ...
    updateBreadcrumb([
      ...
      { name: viewName === 'profile' ? 'My Profile' : (viewName === 'simulations' ? 'Stimulation' : 'Overview'), hash: `#${viewName}` }
    ]);

    if (viewName === 'dashboard') renderDashboardView();
    if (viewName === 'profile') renderProfileView();
    if (viewName === 'simulations') renderSimulationsView();
  ...
  function handleHashNavigation() {
    ...
    if (!hash || hash === 'dashboard') {
      ...
      navigateTo('profile');
    } else if (hash === 'simulations' || hash === 'stimulation') {
  ...
  function renderSimulationEngine(subject, exp) {
    ...
    if (simType === 'ph_scale') {
      return `
        <div class="sim-workbench-iframe-container" style="display: flex; flex-direction: column; gap: 20px; width: 100%;">
          <iframe id="simIframe" src="../simulations/1_7_ph_scale.html" style="width: 100%; height: 800px; border: none; border-radius: 12px; background: #0a0e17; box-shadow: 0 4px 20px rgba(0,0,0,0.25);" title="pH Scale Simulation"></iframe>
          
          <div style="display: flex; justify-content: flex-end; margin-top: 10px;">
            <button class="btn-record-reading" onclick="recordTrialReading('${exp.id}')" style="background-color: var(--accent-chem, #10b981); color: #fff; border: none; padding: 12px 24px; border-radius: 8px; font-family: var(--font-display); font-weight: 600; cursor: pointer; transition: background 0.2s;">Record Trial Reading</button>
          </div>
            ...
            <table class="trials-table">
              <thead>
                <tr>
                  ...
                  <th>Solution Name</th>
                  <th>pH Value</th>
                  <th>[H₃O⁺] Concentration (M)</th>
                  <th>[OH⁻] Concentration (M)</th>
                </tr>
              </thead>
              <tbody id="trialLogBody">
                <tr><td colspan="5" style="text-align: center; color: var(--ink-soft);">No readings recorded yet. Click "Record Trial Reading" above to log data.</td></tr>
              </tbody>
            </table>
          </div>
        </div>
    ...
    if (simType === 'acid_base_solutions') {
      return `
        <div class="sim-workbench-iframe-container" style="display: flex; flex-direction: column; gap: 20px; width: 100%;">
          <iframe id="simIframe" src="../simulations/1_8_acid_base_solutions.html" style="width: 100%; height: 800px; border: none; border-radius: 12px; background: #0a0e17; box-shadow: 0 4px 20px rgba(0,0,0,0.25);" title="Acid-Base Solutions Simulation"></iframe>
    ...
    if (simType === 'reactions_rates') {
      return `
        <div class="sim-workbench-iframe-container" style="display: flex; flex-direction: column; gap: 20px; width: 100%;">
          <iframe id="simIframe" src="../simulations/1_9_reactions_and_rates.html" style="width: 100%; height: 800px; border: none; border-radius: 12px; background: #0a0e17; box-shadow: 0 4px 20px rgba(0,0,0,0.25);" title="Reactions and Rates Simulation"></iframe>
    ...
    if (simType === 'pendulum') {
      return `
        <div class="sim-workbench-iframe-container" style="display: flex; flex-direction: column; gap: 20px; width: 100%;">
          <iframe id="simIframe" src="../simulations/1_1_pendulum_lab.html" style="width: 100%; height: 800px; border: none; border-radius: 12px; background: #0a0e17; box-shadow: 0 4px 20px rgba(0,0,0,0.25);" title="Pendulum Lab Simulation"></iframe>
          
          <div style="display: flex; justify-content: flex-end; margin-top: 10px;">
            <button class="btn-record-reading" onclick="recordTrialReading('${exp.id}')" style="background-color: var(--physics); color: var(--white); border: none; padding: 12px 24px; border-radius: 8px; font-family: var(--font-display); font-weight: 600; cursor: pointer; transition: background 0.2s;">Record Trial Reading</button>
          </div>
    ...
    if (simType === 'skate_park') {
      return `
        <div class="sim-workbench-iframe-container" style="display: flex; flex-direction: column; gap: 20px; width: 100%;">
          <iframe id="simIframe" src="../simulations/1_2_energy_skate_park.html" style="width: 100%; height: 800px; border: none; border-radius: 12px; background: #0a0e17; box-shadow: 0 4px 20px rgba(0,0,0,0.25);" title="Energy Skate Park Simulation"></iframe>
            ...
            <table class="trials-table">
              <thead>
                <tr>
                  ...
                  <th>Gravity g (m/s²)</th>
                  <th>Friction</th>
                  <th>Max Kinetic Energy (J)</th>
                  <th>Max Thermal Energy (J)</th>
                </tr>
              </thead>
              <tbody id="trialLogBody">
                <tr><td colspan="6" style="text-align: center; color: var(--ink-soft);">No readings recorded yet. Click "Record Trial Reading" above to log data.</td></tr>
              </tbody>
            </table>
          </div>
        </div>
    ...
    if (simType === 'forces_motion') {
      return `
        <div class="sim-workbench-iframe-container" style="display: flex; flex-direction: column; gap: 20px; width: 100%;">
          <iframe id="simIframe" src="../simulations/1_3_forces_and_motion.html" style="width: 100%; height: 800px; border: none; border-radius: 12px; background: #0a0e17; box-shadow: 0 4px 20px rgba(0,0,0,0.25);" title="Forces and Motion Simulation"></iframe>
            ...
            <table class="trials-table">
              <thead>
                <tr>
                  ...
                  <th>Friction Force (N)</th>
                  <th>Acceleration (m/s²)</th>
                  <th>Peak Velocity (m/s)</th>
                </tr>
              </thead>
              <tbody id="trialLogBody">
                <tr><td colspan="7" style="text-align: center; color: var(--ink-soft);">No readings recorded yet. Click "Record Trial Reading" above to log data.</td></tr>
              </tbody>
            </table>
          </div>
        </div>
    ...
    if (simType === 'lens_lab') {
      return `
        <div class="sim-workbench-iframe-container" style="display: flex; flex-direction: column; gap: 20px; width: 100%;">
          <iframe id="simIframe" src="../simulations/1_4_lens_lab.html" style="width: 100%; height: 800px; border: none; border-radius: 12px; background: #0a0e17; box-shadow: 0 4px 20px rgba(0,0,0,0.25);" title="Geometric Optics Simulation"></iframe>
            ...
            <table class="trials-table">
              <thead>
                <tr>
                  ...
                  <th>Object Distance (d_o)</th>
                  <th>Image Distance (d_i)</th>
    ...
    if (simType === 'projectile') {
      return `
        <div class="sim-workbench-iframe-container" style="display: flex; flex-direction: column; gap: 20px; width: 100%;">
          <iframe id="simIframe" src="../simulations/1_5_projectile_motion.html" style="width: 100%; height: 800px; border: none; border-radius: 12px; background: #0a0e17; box-shadow: 0 4px 20px rgba(0,0,0,0.25);" title="Projectile Motion Simulation"></iframe>
  ...
  window.recordTrialReading = function (expId) {
    ...
    if (simType === 'titration') {
      const v = doc.getElementById('titrantSlider').value;
      const ph = doc.getElementById('phVal').textContent;
      ...
      `).join('');
    } else if (simType === 'ph_scale') {
      const solution = doc.getElementById('trialSolution') ? doc.getElementById('trialSolution').textContent : 'Pure Water';
      const ph = doc.getElementById('trialPh') ? doc.getElementById('trialPh').textContent : '7.00';
      const h3o = doc.getElementById('trialH3o') ? doc.getElementById('trialH3o').textContent : '1.00e-7';
      const oh = doc.getElementById('trialOh') ? doc.getElementById('trialOh').textContent : '1.00e-7';
      
      trials.push({ num: trials.length + 1, solution, ph, h3o, oh });
      ...
      `).join('');
    } else if (simType === 'acid_base_solutions') {
      const type = doc.getElementById('trialSolType') ? doc.getElementById('trialSolType').textContent : 'Strong Acid';
      const conc = doc.getElementById('trialConc') ? doc.getElementById('trialConc').textContent : '0.100 M';
      const ph = doc.getElementById('trialPh') ? doc.getElementById('trialPh').textContent : '1.00';
      const diss = doc.getElementById('trialDissociation') ? doc.getElementById('trialDissociation').textContent : '100.0%';
      
      trials.push({ num: trials.length + 1, type, conc, ph, diss });
      ...
      `).join('');
    } else if (simType === 'reactions_rates') {
      const temp = doc.getElementById('trialTemp') ? doc.getElementById('trialTemp').textContent : '300 K';
      const catalyst = doc.getElementById('trialCatalyst') ? doc.getElementById('trialCatalyst').textContent : 'Inactive';
      const volume = doc.getElementById('trialVolume') ? doc.getElementById('trialVolume').textContent : '100%';
      const rate = doc.getElementById('trialRate') ? doc.getElementById('trialRate').textContent : '0.00 M/s';
      
      trials.push({ num: trials.length + 1, temp, catalyst, volume, rate });
      ...
      const L = doc.getElementById('lengthSlider').value;
      const T = doc.getElementById('periodVal').textContent;
      const f = doc.getElementById('freqVal').textContent;
      ...
      const v = doc.getElementById('velSlider').value;
      const angle = doc.getElementById('angleSlider').value;
      const R = doc.getElementById('rangeVal').textContent;
      const H = doc.getElementById('hMaxVal').textContent;
      const t = doc.getElementById('flightTimeVal').textContent;
      ...
      const V = doc.getElementById('voltSlider').value;
      const config = doc.getElementById('configSelect').value;
      const Req = doc.getElementById('reqVal').textContent;
      const I = doc.getElementById('currentVal').textContent;
      ...
      `).join('');
    } else if (simType === 'skate_park') {
      const track = doc.getElementById('trialTrack') ? doc.getElementById('trialTrack').textContent : 'Bowl';
      const gravity = doc.getElementById('trialGravity') ? doc.getElementById('trialGravity').textContent : '9.81 m/s²';
      const friction = doc.getElementById('trialFriction') ? doc.getElementById('trialFriction').textContent : 'None';
      const maxKE = doc.getElementById('trialMaxKE') ? doc.getElementById('trialMaxKE').textContent : '0.0 J';
      const maxThermal = doc.getElementById('trialMaxThermal') ? doc.getElementById('trialMaxThermal').textContent : '0.0 J';
      trials.push({ num: trials.length + 1, track, gravity, friction, maxKE, maxThermal });
      ...
      `).join('');
    } else if (simType === 'forces_motion') {
      const surface = doc.getElementById('trialSurface') ? doc.getElementById('trialSurface').textContent : 'Wood';
      const mass = doc.getElementById('trialMass') ? doc.getElementById('trialMass').textContent : '50 kg';
      const applied = doc.getElementById('trialApplied') ? doc.getElementById('trialApplied').textContent : '0 N';
      const friction = doc.getElementById('trialFriction') ? doc.getElementById('trialFriction').textContent : '0 N';
      const accel = doc.getElementById('trialAcceleration') ? doc.getElementById('trialAcceleration').textContent : '0.00 m/s²';
      const peakVel = doc.getElementById('trialMaxVel') ? doc.getElementById('trialMaxVel').textContent : '0.00 m/s';
      trials.push({ num: trials.length + 1, surface, mass, applied, friction, accel, peakVel });
      ...
      `).join('');
    } else if (simType === 'lens_lab') {
      const lensType = doc.getElementById('trialLensType') ? doc.getElementById('trialLensType').textContent : 'Convex';
      const focalLength = doc.getElementById('trialFocalLength') ? doc.getElementById('trialFocalLength').textContent : '20.0 cm';
      const objectDist = doc.getElementById('trialObjectDist') ? doc.getElementById('trialObjectDist').textContent : '30.0 cm';
      const imageDist = doc.getElementById('trialImageDist') ? doc.getElementById('trialImageDist').textContent : '60.0 cm';
      const magnification = doc.getElementById('trialMagnification') ? doc.getElementById('trialMagnification').textContent : '-2.00';
      const imageType = doc.getElementById('trialImageType') ? doc.getElementById('trialImageType').textContent : 'Real / Inverted';
      trials.push({ num: trials.length + 1, lensType, focalLength, objectDist, imageDist, magnification, imageType });
  ...
  const simulationsList = [
    {
      ...
      subject: 'Physics',
      subjectKey: 'phy',
      file: '1_1_pendulum_lab.html',
      desc: 'Study gravitational force, mass, drag, and length by adjusting and graphing a swinging pendulum.',
      icon: '⚖️'
    },
    {
      id: 'skatepark',
      ...
      subject: 'Physics',
      subjectKey: 'phy',
      file: '1_2_energy_skate_park.html',
      desc: 'Design tracks, ramps, and loops to analyze kinetic, potential, and thermal energy conservation.',
      icon: '🛹'
    },
    {
      id: 'forces',
      ...
      subject: 'Physics',
      subjectKey: 'phy',
      file: '1_3_forces_and_motion.html',
      desc: 'Push objects with custom forces and observe friction, mass, and velocity charts.',
      icon: '🏃'
    },
    {
      id: 'optics',
      ...
      subject: 'Physics',
      subjectKey: 'phy',
      file: '1_4_lens_lab.html',
      desc: 'Interact with lenses, light sources, and rays to discover focal length, refraction, and magnification.',
      icon: '🔍'
    },
    {
      id: 'projectile',
      ...
      subject: 'Physics',
      subjectKey: 'phy',
      file: '1_5_projectile_motion.html',
      desc: 'Launch everyday items from a cannon, altering mass, diameter, angle, velocity, and air resistance.',
      icon: '☄️'
    },
    {
      id: 'atom',
      ...
      subject: 'Chemistry',
      subjectKey: 'chem',
      file: '1_6_build_an_atom.html',
      desc: 'Drag protons, neutrons, and electrons to construct neutral atoms or ions and learn element classification.',
      icon: '⚛️'
    },
    {
      id: 'phscale',
      ...
      subject: 'Chemistry',
      subjectKey: 'chem',
      file: '1_7_ph_scale.html',
      desc: 'Measure the pH of household items with a digital meter, studying logarithm-linked ion concentrations.',
      icon: '🧪'
    },
    {
      id: 'acidbase',
      ...
      subject: 'Chemistry',
      subjectKey: 'chem',
      file: '1_8_acid_base_solutions.html',
      desc: 'Observe chemical equilibrium and dissociation at a molecular level with strong and weak acids/bases.',
      icon: '💧'
    },
    {
      id: 'reactions',
      ...
      subject: 'Chemistry',
      subjectKey: 'chem',
      file: '1_9_reactions_and_rates.html',
      desc: 'Animate a 2D collision chamber to examine particle concentrations, temperature, and catalysts.',
      icon: '💥'
    }
  ];
  ...
  function renderSimulationsView() {
    ...
    if (state.activeSimFile) {
      container.innerHTML = `
        <div class="sim-view-wrapper" style="display: flex; flex-direction: column; gap: 20px; width: 100%;">
          <div class="sim-view-header" style="display: flex; align-items: center; justify-content: space-between; background: var(--panel-bg); border: 1px solid var(--panel-border); padding: 14px 20px; border-radius: 12px; backdrop-filter: blur(12px);">
            <button onclick="closeActiveSimulation()" style="background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15); color: #fff; padding: 10px 18px; border-radius: 8px; font-family: var(--font-display); cursor: pointer; transition: all 0.2s; display: flex; align-items: center; gap: 8px;">
              &larr; Back to Stimulation
            </button>
            <h2 style="margin: 0; font-family: var(--font-display); font-size: 1.3rem; font-weight: 700; color: var(--ink-deep, #fbFAF5);">${state.activeSimTitle}</h2>
            <div style="width: 160px;"></div>
          </div>
          <iframe id="activeSimIframe" src="../simulations/${state.activeSimFile}" style="width: 100%; height: 780px; border: none; border-radius: 12px; background: #0a0e17; box-shadow: 0 4px 20px rgba(0,0,0,0.25);" title="${state.activeSimTitle}"></iframe>
        </div>
      `;
    } else {
      container.innerHTML = `
        <div class="welcome-header" style="margin-bottom: 24px;">
          <h1 class="welcome-title">Interactive Labs Sandbox</h1>
          <p class="welcome-subtitle">Directly access and launch any interactive simulation to conduct virtual experiments, inspect physics models, or balance chemistry equations.</p>
        </div>

        <style>
          .sim-card-box {
            background: var(--panel-bg, rgba(23,29,46,0.75));
        ...
        <div class="sims-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 24px;">
          ${simulationsList.map(sim => `
            <div class="sim-card-box">
              <div style="display: flex; flex-direction: column; gap: 12px;">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                  <span style="font-size: 2.2rem;">${sim.icon}</span>
                  <span class="tag-pill mono" data-subject="${sim.subjectKey}" style="font-size: 0.75rem; text-transform: uppercase;">${sim.subject}</span>
                </div>
                <h3 style="font-family: var(--font-display, 'Space Grotesk'); font-size: 1.2rem; font-weight: 700; color: var(--ink-deep, #fbFAF5); margin: 0;">${sim.title}</h3>
                <p style="color: var(--ink-soft, #8e9bb8); font-size: 0.88rem; line-height: 1.5; font-family: var(--font-body, 'Inter'); margin: 0;">${sim.desc}</p>
              </div>
              <button onclick="launchSimulation('${sim.file}', '${sim.title.replace(/'/g, "\\'")}')" style="width: 100%; display: flex; justify-content: center; align-items: center; gap: 8px; background-color: ${sim.subjectKey === 'chem' ? 'var(--accent-chem, #37B7A0)' : 'var(--accent-phy, #7c3aed)'}; color: #fff; border: none; padding: 12px 20px; border-radius: 8px; font-family: var(--font-display); font-weight: 600; cursor: pointer; transition: filter 0.2s;">
  ...
  function launchSimulation(file, title) {
    state.activeSimFile = file;
    state.activeSimTitle = title;
    renderSimulationsView();
  }

  function closeActiveSimulation() {
    state.activeSimFile = null;
    state.activeSimTitle = null;
    renderSimulationsView();
  }
  ...
  window.closeActiveSimulation = closeActiveSimulation;
